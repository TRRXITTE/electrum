...
TRAMPOLINE_NODES_MAINNET = {
    'TRRXITTE lightning':                  LNPeerAddr(host='electrum-en.trrxitte.com',           port=9735, pubkey=bytes.fromhex('03864ef025fde8fb587d989186ce6a4a186895ee44a926bfc370e2c366597a3f8f')),
}
